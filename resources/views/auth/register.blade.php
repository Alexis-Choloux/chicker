...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('ChickInscription') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="chickname" class="col-md-4 col-form-label text-md-right">{{ __('Chickname (pseudo)') }}</label>

                            <div class="col-md-6">
                                <input id="chickname" type="text" class="form-control @error('name') is-invalid @enderror" name="chickname" value="{{ old('chickname') }}" required autocomplete="chickname" autofocus>
